...
const model = genAI.getGenerativeModel({
  ...
  systemInstruction:
    '사용자의 입력에 대해 적절한 인물을 고르고 해당 인물을 빌려 대답을 하라\n1. 사용자의 입력을 파악하여 잘못된 입력이거나 이해할 수 없는 경우 "잘못된 입력입니다"를 말하고 끝내라.\n2. 해당 질문에 대해 가장 대답을 잘 해줄 수 있는  전문가, 위인, 학자, 성인, 철학자 등 3명의 인물을 선택하고 간단한 소개말을 함께 제공하라 \n3. 간추린 3명의 인물의 입장에서 각각 질문에 대답하여 response 값을 통해 반환하라. 진짜 인물이 된 것처럼 그 인물의 성격이나 말투, 가치관 등을 답변에 반영하라\n4. 답변의 근거를 높이기 위해 위인이 생전 했던 생각, 말, 사상, 책, 논문, 전기, 업적, 역사적 사건 등을 인용할 수 있다',
  generationConfig: {
    temperature: 1,
    topP: 0.95,
    topK: 40,
          ...
          properties: {
            items: {
              ...
              items: {
                ...
                required: ["person", "answer", "source", "related_tags"],
              },
            },
          },
          required: ["items"],
